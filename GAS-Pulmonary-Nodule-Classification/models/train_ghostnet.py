...
# 设置日志记录
log_filename = os.path.join(log_dir, f'ghostnet_training1_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
...
num_epochs = 96
best_accuracy = 0.0
best_model_path = 'ghostnet_best_model1.pth'
