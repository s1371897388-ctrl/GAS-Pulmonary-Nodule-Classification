...
# 设置日志记录
log_filename = os.path.join(log_dir, f'DWCGhost_training2_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
...
num_epochs = 96
best_accuracy = 0.0
best_model_path = 'DWCGhost_best_model2.pth'
