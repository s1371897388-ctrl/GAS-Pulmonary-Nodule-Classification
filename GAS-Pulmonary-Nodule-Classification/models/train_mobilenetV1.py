...
# 设置日志记录
log_filename = os.path.join(log_dir, f'mobilenetV1_training1_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
...
# 保存初始参数
logging.info(f'Model: MobileNetV1')
...
num_epochs = 96
best_accuracy = 0.0
best_model_path = 'mobilenetV1_best_model1.pth'
