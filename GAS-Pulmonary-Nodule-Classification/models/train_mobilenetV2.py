...
# 设置日志记录
log_filename = os.path.join(log_dir, f'mobilenetV2_training2_log_{datetime.now().strftime("%Y%m%d_%H%M%S")}.log')
...
# 保存初始参数
logging.info(f'Model: MobileNetV2')
...
num_epochs = 96
best_auc = 0.0
best_model_path = 'mobilenetV2_best_model2.pth'
